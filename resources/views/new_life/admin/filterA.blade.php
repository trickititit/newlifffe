    ...
    {!! Form::open(["url" => URL::current(), 'method' => "GET"]) !!}
        <div class="row bg_top">
            <div class="col-md-12 top_filter">
                ...
                <input id="amount-area_1" readonly="" style="display: none;" name="" type="text" value="Район" data-popover = "true" data-popover-content = ".area_1_search"  data-checkbox = "true" data-show = "true">
                    <div class="area_1_search hidden">
                        <label><input name="area1[]" type="checkbox" value="1">Красноармейский</label>
                        <label><input name="area1[]" type="checkbox" value="2">Кировский</label>
                    </div>
                <input id="amount-area_2" readonly="" name="" type="text" value="Район" data-popover = "true" data-popover-content = ".area_2_search"  data-checkbox = "true" data-show = "true">
                    <div class="area_2_search hidden">
                        <label><input name="area2[]" type="checkbox" value="110">Старый город</label>
                        <label><input name="area2[]" type="checkbox" value="111">Новый город</label>
                    </div>
